/***********************************************************************
 *                                                                     *
 * $Id: hpgs.h 535 2010-06-09 18:26:52Z hpgs $
 *                                                                     *
...
#ifdef WIN32
# ifdef WIN64
#  define HPGS_SIZE_T_FMT "%I64u"
#  define HPGS_SIZE_T_FMT_ARG(i) (unsigned long long)(i)
#  define HPGS_SIZE_T_FMT_ARG_P(i) (unsigned long long *)(i)
# else
#  define HPGS_SIZE_T_FMT "%lu"
#  define HPGS_SIZE_T_FMT_ARG(i) (unsigned long)(i)
#  define HPGS_SIZE_T_FMT_ARG_P(i) (unsigned long *)(i)
# endif
#else
