/***********************************************************************
 *                                                                     *
 * $Id: hpgsimagerop.c 510 2009-09-25 16:20:35Z softadm $
 *                                                                     *
...
/*! 
   ...
   Return values:
     ...
     \li 3 The clip frame is not empty, the visible pixels have all the same color
           ...
           altered. It is assumed, that the output device has the ROP function set to
           the same as the funciton passed in as argument \c xrop3.
                         ...
                         hpgs_xrop3_func_t xrop3)
{
  ...
  hpgs_img_clip_seg *segs0 = (hpgs_img_clip_seg *)
    malloc(sizeof(hpgs_img_clip_seg)*(img->width+1));
  ...
  if (!clip_lines || !segs0 || !segs1) {
    hpgs_set_error(hpgs_i18n("hpgs_image_rop3_clip: Out of memory allocating temporary storage."));
    goto cleanup;
  }
  ...
  hpgs_paint_color first_visible_color = { 0,0,0,0 };
  ...
  if (single_color)
    {
      ...
      c.r = first_visible_color.r / 255.0;
      c.g = first_visible_color.g / 255.0;
      c.b = first_visible_color.b / 255.0;
