/***********************************************************************
 *                                                                     *
 * $Id: hpgsreader.h 489 2009-02-11 14:10:30Z softadm $
 *                                                                     *
...
struct hpgs_reader_st
{
  ...
  hpgs_reader_pcl_palette **pcl_palettes; /*!< The PCL palette stack of palattes for 256 colors. */
  size_t pcl_n_palettes; /*!< The allocated size of the palette stack.*/
  int pcl_i_palette;     /*!< The number of of the current PCL palette on the stack. */

  int pcl_pattern; /*!< The current PCL pattern. Default value 0. */
  hpgs_palette_color pcl_foreground_color; /*!< The currently set PCL forground color.
                                                Set to black, if no foreground color is set. */
